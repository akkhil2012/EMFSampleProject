...
public class WebpagePackageImpl extends EPackageImpl implements WebpagePackage {
	 ...
	 * @generated
	 */
	public EOperation getArticle__ToString() {
	 ...
	 * @generated
	 */
	public EOperation getArticle__Test__int() {
	 ...
	 * @generated
	 */
	public EDataType getCalender() {
		return calenderEDataType;
	}
	...
	public void createPackageContents() {
		...
		createEOperation(articleEClass, ARTICLE___TO_STRING);
		createEOperation(articleEClass, ARTICLE___TEST__INT);

		// Create data types
		calenderEDataType = createEDataType(CALENDER);
	}
	...
	public void initializePackageContents() {
		...
		initEOperation(getArticle__ToString(), ecorePackage.getEString(), "toString", 0, 1, IS_UNIQUE, IS_ORDERED);

		EOperation op = initEOperation(getArticle__Test__int(), ecorePackage.getEInt(), "test", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "input", 0, 1, IS_UNIQUE, IS_ORDERED);

		// Initialize data types
		initEDataType(calenderEDataType, Calendar.class, "Calender", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
