...
import akkhil.emf.webpage.model.webpage.Article;
 ...
 * </p>
 * <ul>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.CategoryImpl#getArticles <em>Articles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	public EList<Article> getArticles() {
		if (articles == null) {
			articles = new EObjectResolvingEList<Article>(Article.class, this, WebpagePackage.CATEGORY__ARTICLES);
		}
		return articles;
	}
