...
public class WebpageFactoryImpl extends EFactoryImpl implements WebpageFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case WebpagePackage.WEB: return createWeb();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case WebpagePackage.CALENDER:
				return createCalenderFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case WebpagePackage.CALENDER:
				return convertCalenderToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Calendar createCalenderFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertCalenderToString(EDataType eDataType, Object instanceValue) {
