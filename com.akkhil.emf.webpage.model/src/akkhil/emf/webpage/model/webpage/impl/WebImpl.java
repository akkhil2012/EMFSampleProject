 ...
 * </p>
 * <ul>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.WebImpl#getName <em>Name</em>}</li>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.WebImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.WebImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.WebImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link akkhil.emf.webpage.model.webpage.impl.WebImpl#getWebpage <em>Webpage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WebImpl extends MinimalEObjectImpl.Container implements Web {
	...
	public EList<Webpage> getWebpage() {
		if (webpage == null) {
			webpage = new EObjectResolvingEList<Webpage>(Webpage.class, this, WebpagePackage.WEB__WEBPAGE);
		}
		return webpage;
	}
