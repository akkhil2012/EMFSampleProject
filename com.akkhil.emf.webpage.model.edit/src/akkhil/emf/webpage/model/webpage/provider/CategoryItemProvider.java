...
/**
 * This is the item provider adapter for a {@link akkhil.emf.webpage.model.webpage.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addArticlesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_articles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_articles_feature", "_UI_Category_type"),
